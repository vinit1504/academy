...
import redux from './assets/technology-icon/icons8-redux-50.png' 
import android from './assets/technology-icon/android.png'
import ios from './assets/technology-icon/apple.png'
import express from './assets/technology-icon/express.png'
import reactnative from './assets/technology-icon/Rectangle 1.png'
import mongo from './assets/technology-icon/mongodb.png'
import sql from './assets/technology-icon/sql2.png'
import postman from './assets/technology-icon/postmen.png'
import jest from './assets/technology-icon/humorist.png'
...
import psql from './assets/technology-icon/psql.png'
import figma from './assets/technology-icon/figma.png'
import sketch from './assets/technology-icon/sketching.png'
...
import panda from './assets/technology-icon/panda-bear.png'
import mat from './assets/technology-icon/mat2.png'
import learn from './assets/technology-icon/Scikit.png'
import jupyter from './assets/technology-icon/jupyter (2).png'
import docker from './assets/technology-icon/docker.png'
import hadoop from './assets/technology-icon/What is Hadoop.jpg'
import aws from './assets/technology-icon/web.png'
import cgp from './assets/technology-icon/cgp.png'
import tenserflow from './assets/technology-icon/flow.png'
...
const data = [
  ...
  },
  {
    ...
    "backgroundImage": "react-native.png",
    image: "ReactNative",
    "toolsAndTechnology": [
      { "name": "React", image:reactjs },
  ...
  {
    "id": 4,
    "title": "React Native and Node.js",
    ...
    "backgroundImage": "react-native-nodejs.png",
  ...
  },
  {
    ...
    "backgroundImage": "python_full_stack.png",
  ...
  },
  {
    ...
    "backgroundImage": "data_science_python.png",
  ...
  },
  {
    ...
    "backgroundImage": "data_engineering_python.png",
