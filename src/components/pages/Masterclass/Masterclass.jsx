  ...
  return (
    <>
      ...
      <div className="master-class-info">
        <h1 className='text-2xl sm:text-3xl md:text-5xl font-bold  pb-10'>Who is this master class for?</h1>
      ...
      <div className="refer-earn-community">
        <div className="card">
          <div className="re">
            <h2>Refer & Earn</h2>
            <p>Invite your friends to join Fynd Academy and register for our amazing courses!</p>
          </div>
          <div className="re1">
        ...
        <div className="card">
          <div className="re">
            <h2>Our Community</h2>
            <p>Join our Community at Fynd Academy and start your path to growth and success today!</p>
          </div>
          <div className="re1">
