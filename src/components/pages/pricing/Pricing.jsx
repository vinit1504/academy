                    ...
                    <div className="relative isolate px-6 pt-8 lg:px-8">
                        ...
                        <div className="">
                            ...
                            <div className="question-container sm:flex w-[90%] mx-auto top-0 sm:mt-24">
                                <h1 className='sticky-header w-auto text-xl md:text-5xl sm:mt-24 sm:text-3xl tracking-wider text-center font-bold mt-12 mb-5 '>Frequently Asked Questions</h1>
                                <Question />
                            </div>
                        </div>
                    </div>
