        ...
        <div className="relative isolate px-6 pt-8 lg:px-8">
          ...
          <div className="">
            <div className="w-[90%] mx-auto">
              <div className="flex flex-col lg:flex-row justify-between items-center">
                <div>
                  ...
                  <p className="mt-4 text-lg text-gray-700 w-[70%]">
                    {post.description}
                  </p>
                ...
                <button className="mt-6 px-6 py-6 bg-purple-600 text-white rounded-full w-[70%] sm:w-[20%] mx-auto">
                  Register Now
                </button>
              </div>
              <div className="mt-12">
            ...
            <div className="mt-16 text-xl sm:text-4xl text-center font-bold mb-5">
              ...
              <div className="flex flex-wrap justify-center gap-4 p-4 w-[100%] sm:w-[80%] mx-auto ">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className={`bg-white rounded-lg shadow-md py-8 px-4 max-w-sm text-start w-[100%]`}
                  >
            ...
            <div className="question-container sm:flex w-[90%] mx-auto top-0 sm:mt-24">
              <h1 className="sticky-header w-auto text-xl md:text-5xl sm:mt-24 sm:text-3xl tracking-wider text-center font-bold mt-12 mb-5 ">
