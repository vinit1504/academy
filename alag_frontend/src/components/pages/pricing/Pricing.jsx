              ...
              <div className="flex flex-col lg:flex-row justify-between items-center">
                <div>
                  ...
                  <div className="mt-6 flex flex-col lg:flex-row lg:space-x-8 space-y-4 lg:space-y-0">
                    <div>
                      <h2 className="text-xl  text-gray-800 font-bold mt-2">
                        Google Meet
                      </h2>
                ...
                <button className="mt-10 p-5 bg-purple-700  flex items-center justify-center  text-white rounded-full w-[70%] sm:w-[60%] mx-auto">
                  <p>Register Now </p>
